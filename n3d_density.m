...
kernel_density_est = kernel_density_est/M;


figure;
plot(kernel_points, kernel_density_est, 'o-', 'LineWidth',2);
hold on;
title('Invariant Distribution of the 2nd component of $X_t$');
fontsize(14, "points");
ylim([0,1.6]);
xlabel('$x$');
